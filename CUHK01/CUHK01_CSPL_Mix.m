...
galFea3 = camA2(:, p(1:485));
galFea4 = camA2(:, p(486:970));

galFea5 = (galFea1+galFea3)./2;
galFea6 = (galFea2+galFea4)./2;

probeFea1 = camB1(:, p(1:485));
probeFea2 = camB1(:, p(486:970));
probeFea3 = camB2(:, p(1:485));
probeFea4 = camB2(:, p(486:970));

probeFea5 = (probeFea1+probeFea3)./2;
probeFea6 = (probeFea2+probeFea4)./2;
...
%X22 = galFea2;
    ...
    TrainSet(1:485 ,:) = galFea5';
    TrainSet(486: end,:) = probeFea5';
    
    TestSet = zeros(970,35722);
    TestSet(1:485 ,:) = galFea6';
    TestSet(486: end,:) = probeFea6';
